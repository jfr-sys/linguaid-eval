...
function getDriveClient() {
  if (!fs.existsSync(CREDENTIALS_PATH) || !fs.existsSync(TOKEN_PATH)) {
    throw new Error('Drive not authorized yet. Run authorize_drive.js first.');
  }
...
const CURRENT_STUDENTS_FOLDER_IDS = {
  ...
  louise: '12WPk4hMsA3MWNX4I-gvjZh_dY_yaaFMJ',
 ...
 */
async function pushCandidateDocs({ trainerKey, learnerName, files, rootFolderId }) {

...
function checkProgrammeMatch(c) {
  ...
  function normArr(v) { return JSON.stringify(Array.isArray(v) ? v : []); }
  ...
  var fieldChecks = [
    ...
    ['totalHours',    function(s) { return norm(s.totalHours); },   'heures totales'],
    ['coachingHours', function(s) { return norm(s.coachingHours); },'heures de coaching'],
    ['homeworkHours', function(s) { return norm(s.homeworkHours); },'heures de travaux en autonomie'],
...
module.exports = { checkCoherence: checkCoherence, deriveTotal: deriveTotal, normaliseHours: normaliseHours, checkProgrammeMatch: checkProgrammeMatch };

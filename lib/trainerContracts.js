...
const TRAINER_CONTRACTS = {
  anna: {
    ...
    tva: false,
    devisTemplate: "DEVIS_ANNA_TEMPLATE.docx",
    devisPrefix: "AM",
    hasHomework: true,
    cachet: { anchor: "Cachet", x: 158, w: 125, center: false },
  },
  hannah: {
    ...
    avenantDate: "15 mars 2024",
    tva: false,
    devisTemplate: "DEVIS_HANNAH_TEMPLATE.docx",
    devisPrefix: "HD",
    hasHomework: true,
    cachet: { anchor: "accord", w: 130, center: true },
  },
  leone: {
    ...
    tva: false,
    devisTemplate: "DEVIS_LEONE_TEMPLATE.docx",
    devisPrefix: "LC",
    hasHomework: true,
    cachet: { anchor: "accord", w: 130, center: true },
  },
  stephanie: {
    ...
    devisTemplate: "DEVIS_STEPHANIE_TEMPLATE.docx",
    devisPrefix: "SCS",
    hasHomework: false,
    cachet: { anchor: "cachet", w: 130, center: true },
  },
  lynsey: {
    ...
    devisTemplate: "DEVIS_LYNSEY_TEMPLATE.docx",
    devisPrefix: "LR",
    hasHomework: false,
    cachet: { anchor: "foi", w: 130, center: true },
  },
  louiseg: {
    ...
    avenantDate: "18 mars 2024",
    tva: false,
    devisTemplate: "DEVIS_Louise_G_TEMPLATE.docx",
    devisPrefix: "LG",
    hasHomework: true,
    cachet: { anchor: "Cachet", x: 158, w: 125, center: false },
  },

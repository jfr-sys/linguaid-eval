...
function getTransporter() {
  return require('../lib/mailer').createTransport();
}
...
router.post('/api/rewrite-objectives/:id', async function (req, res) {
  ...
  const prompt = [
    ...
    '3. Chaque objectif contient trois elements et rien de plus: (a) la performance observable, (b) le contexte professionnel du candidat, (c) UN SEUL critere de reussite simple (autonomie, clarte, niveau CECRL ou aisance). Jamais deux criteres, jamais un critere chiffre.',
    ...
    '6. Longueur STRICTE: 15 a 25 mots par objectif. Une seule phrase, une seule idee, une proposition subordonnee au maximum.',
    '6b. Style sobre et direct: pas de parentheses contenant des listes d exemples, pas de tirets longs, pas d enumeration de trois elements, pas de double negation, pas de subordonnees empilees.',
    '6c. Francais professionnel simple et accentue, immediatement comprehensible par un client non specialiste. Aucun jargon pedagogique dans le texte de l objectif.',
    ...
    'Apres: Animer une reunion en anglais avec un interlocuteur anglophone, en autonomie et sans repasser par le francais.',
    'C est exactement la cible: court, concret, verifiable. Ne produis jamais plus detaille que cet exemple.',
    '',
    'PROFIL DU CANDIDAT:',
    '- Poste: ' + (c.jobtitle || 'non precise'),
    '- Departement: ' + (c.dept || 'non precise'),
    ...
    '- "evaluation": comment cet objectif sera evalue, en 15 mots maximum: le type de tache et le critere observe. Pas de duree, pas de nombre de mots, pas de grille chiffree.',
    '',
